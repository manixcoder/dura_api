...
class CartController extends Controller
{
    ...
    public function shedule_pickup(Request $request)
    {
        ...
        else 
        {
            try 
            { 
                $pickupshedule =array( "pickup_address1"=> $request->pickup_address1,
...
public function driver_current_location(Request $request)
    ...
    {
        $secret = "f14239f451034e518067b52c0ad3148e";    // APP fixed key, inget itunes
