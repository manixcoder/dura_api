...
{    
    ...
    public function getpromocode(Request $request)
    {
        ...
        else 
        {
            try {
                ...
                //die;
                // $promodata = DB::table('promocode')->where('created_at' , '>=' , Carbon::now()->toDateTimeString())->get();
                $promodata = DB::table('promocode')->get(); 
                // echo "<pre>";
                // print_r($promodata);
                // die;
                ...
                return response()->json(['StatusCode' => 422, 'status' => 'Failed','message' => $e->getMessage()], 409);
            }
        }
    }
    ...
    public function otpsent()
    {
        ...
        $message = $twilio->messages->create("+917979948924", // to 
                   array(
                       "messagingServiceSid" => env('TWILIO_FROM'),
                       "body" => "Test" 
                       )
